...
class MoreInformationItemWidget extends StatefulWidget {
  final CourseModel course;

  const MoreInformationItemWidget({Key? key, required this.course})
      : super(
          key: key,
        );

  @override
  _MoreInformationItemWidget createState() => _MoreInformationItemWidget();
}

class _MoreInformationItemWidget extends State<MoreInformationItemWidget> {
