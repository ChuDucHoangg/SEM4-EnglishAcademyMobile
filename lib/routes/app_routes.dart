...
import 'package:english_academy_mobile/presentation/my_learning_quiz_results_screen/my_learning_quiz_results_screen.dart';
import 'package:english_academy_mobile/presentation/notification_screen/notification_screen.dart';
import 'package:flutter/material.dart';
import 'package:english_academy_mobile/presentation/my_learning_open_quiz_one_screen/my_learning_open_quiz_one_screen.dart';
...
import '../presentation/my_learning_open_quiz_two_screen/my_learning_open_quiz_two_screen.dart';
...
class AppRoutes {
  ...
  static const String myLearningOpenQuizOneScreen = '/my_learning_open_quiz_one_screen';

  static const String myLearningOpenQuizTwoScreen = '/my_learning_open_quiz_two_screen';

  static const String myLearningOpenQuizResultsScreen = '/my_learning_open_quiz_results_screen';
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    myLearningOpenQuizOneScreen : (context) => MyLearningOpenQuizOneScreen(),
    myLearningOpenQuizTwoScreen : (context) => MyLearningOpenQuizTwoScreen(),
    myLearningOpenQuizResultsScreen : (context) => MyLearningQuizResultsScreen(),
  };
}
